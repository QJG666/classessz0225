...
public class Flink07_State_BroadState_OP {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取流中的数据
        DataStreamSource<String> propertiesStream = env.socketTextStream("hadoop106", 8888);
        DataStreamSource<String> dataStream = env.socketTextStream("hadoop106", 9999);
