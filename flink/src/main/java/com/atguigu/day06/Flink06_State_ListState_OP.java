...
public class Flink06_State_ListState_OP {
    public static void main(String[] args) throws Exception {
        ...
        // 3. 统计元素的个数
        waterSensor1DS.map(new MyMapFunc()).print();
    ...
    public static class MyMapFunc implements MapFunction<WaterSensor1, Integer>, CheckpointedFunction {
        ...
        @Override
        public Integer map(WaterSensor1 value) throws Exception {
            count++;
            return count;
        }
