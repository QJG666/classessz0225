...
import com.atguigu.bigdata.spark.project.bean.HotCategory
import com.atguigu.bigdata.spark.project.common.TService
import com.atguigu.bigdata.spark.project.dao.HotCategoryAnalysisTop10Dao
...
class HotCategoryAnalysisTop10Service extends TService {
  ...
  def analysis5() = {
    ...
    val categories = accMap.map(_._2)
